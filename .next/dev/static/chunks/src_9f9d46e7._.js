...
function NutritionSphere() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NutritionSphere.useEffect": ()=>{
            const convertedTasks = todos.map({
                "NutritionSphere.useEffect.convertedTasks": (todo)=>({
                        id: todo.id,
                        description: todo.title,
                        isCompleted: todo.completed,
                        subtasks: todo.description ? [
            ...
            }["NutritionSphere.useEffect.convertedTasks"]);
...
_s(NutritionSphere, "+AcMTYlOeyYHS1YLtloHdac6Gcw=", false, function() {
    return [
...
//# sourceMappingURL=src_9f9d46e7._.js.map