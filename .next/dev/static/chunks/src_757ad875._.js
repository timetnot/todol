...
function FinancesSphere() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FinancesSphere.useEffect": ()=>{
            const convertedTasks = todos.map({
                "FinancesSphere.useEffect.convertedTasks": (todo)=>({
                        id: todo.id,
                        description: todo.title,
                        isCompleted: todo.completed,
                        subtasks: todo.description ? [
            ...
            }["FinancesSphere.useEffect.convertedTasks"]);
...
_s(FinancesSphere, "+AcMTYlOeyYHS1YLtloHdac6Gcw=", false, function() {
    return [
...
_c = FinancesSphere;
var _c;
__turbopack_context__.k.register(_c, "FinancesSphere");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_757ad875._.js.map