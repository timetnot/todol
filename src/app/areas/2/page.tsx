...
export default function FamilySphere() {
        ...
        <div className="sphere-page">
            ...
            <header className="header-simple">
                ...
                <div className="hero-compact">
                    <div className="hero-icon">{familySphereConfig.icon}</div>
                    <h1>{familySphereConfig.title}</h1>
                </div>
            </header>
                ...
                <div className="tasks-container">
                    {mainTasksList.length === 0 ? (
                        <div className="empty-state">
                            <p>Создай первую задачу для семьи</p>
                        </div>
                    ) : (
